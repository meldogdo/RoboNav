...
public class HomeFragment extends Fragment {
    ...
    private void loadData() {
        ...
        String token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsInVzZXJuYW1lIjoiYWRtaW4iLCJpYXQiOjE3NDE0Njc0MDcsImV4cCI6MTc0MTQ3MTAwN30.cYpnPc5Rd46MXBFrfho4r17w-xHlJjPTkhUrJf3EIxg"; // Ensure this token is up to date
